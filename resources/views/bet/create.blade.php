                    ...
                    <div class="card-body">
                        <div class="container-fluid justify-content-center align-items-center py-3">
                            <div class="justify-content-center align-items-center row">
                                <div class="col-4 d-flex align-items-start flex-column jsutify-content-center">
                                    <h5 class="card-title text-dark">Pronostico</h5>
                                    <h6 class="card-subtitle text-muted">Inserisci il pronostico per l'Incontro n°1</h6>
                                </div>
                                <img src="https://picsum.photos/200" class="col-3" width="120" height="80" alt="">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="justify-content-center align-items-center flex-column container-fluid">
                                ...
                                <div class="mb-3 row justify-content-center align-items-center border border-info border-1 pb-3 rounded-2 shadow">
                                    <div class="text-dark w-100 text-center col-12 my-3">Inserisci il risultato esatto per SquadraCasa vs SquadraFuoriCasa.</div>
                                    <label for="resultHome" class="col-5 form-label text-dark d-flex align-items-center justify-content-center">Risultato Esatto Casa: SquadraCasa</label>
                                    <div class=" col-1 ">
                                    ...
                                    <label for="resultAway" class="col-5 form-label text-dark d-flex align-items-center justify-content-center">Risultato Esatto Fuoricasa: Squadra Fuoricasa </label>
                                </div>
                                ...
                                <div class="mb-3 row justify-content-center align-items-center border border-1 border-info rounded-2 shadow pb-3">
                                    ...
                                    <label class="form-label col-3 d-flex justify-content-center align-items-center" for="homeScore">Gol SquadraCasa</label>
                                    ...
                                    <label class="form-label d-flex justify-content-center align-items-center col-3" for="awayScore">Gol SquadraFuoriCasa</label>
                                </div>
